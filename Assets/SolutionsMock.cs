...
public class SolutionsMock : MonoBehaviour
{
    ...
    IEnumerator mock(){
        ...
        bew.Add(new Bewegung(Spielstein.MOVEDIRECTION.right, Bewegung.FARBEN.gelb));
        ...
        bew2.Add(new Bewegung(Spielstein.MOVEDIRECTION.right, Bewegung.FARBEN.blau));
        bew2.Add(new Bewegung(Spielstein.MOVEDIRECTION.top, Bewegung.FARBEN.blau));
        bew2.Add(new Bewegung(Spielstein.MOVEDIRECTION.left, Bewegung.FARBEN.blau));
        ...
        bew2.Add(new Bewegung(Spielstein.MOVEDIRECTION.right, Bewegung.FARBEN.gelb));
        bew2.Add(new Bewegung(Spielstein.MOVEDIRECTION.top, Bewegung.FARBEN.gelb));
